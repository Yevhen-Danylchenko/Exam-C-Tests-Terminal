	...
	void adminMenu()
	{
		...
		while (adminChoice == "y" || adminChoice == "Y")
		{
				...
				// Додати адміністратора
			{
				...
				int shift = 7; // Зсув для шифрування Цезаря
			...
			break;
			case 2:
				// Оновити логін та пароль адміністратора
			{
			...
			break;
			case 3:
				// Створити базу даних та таблиці (якщо не створені)
			{
			...
			case 6:
				// Керувати тестами (додати питання)
			{
				...
				std::cin >> subCategory;
				for (int i = 0; i < 10; i++) // Цикл для додавання одного питання, можна змінити кількість ітерацій для додавання більше питань
				{
